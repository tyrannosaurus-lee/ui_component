...
exports.randomTimer = exports.dummyFetcher = exports.debounce = void 0;
...
const dummyFetcher = (method, args) => new Promise(randomTimer(method, args)); // 시간지연 시켜줌
...
const debounce = (func, delay) => {
  ...
  return function () {
    ...
    clearTimeout(timeoutId); // 다시 timeoutId이 걸린다. 취소되지 않은 마지막것만 남게 된다
...
//# sourceMappingURL=/debounce_throttle.e31bb0bc.js.map