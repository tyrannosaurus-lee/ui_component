...
const dummyFetcher = (method, args) => new Promise(randomTimer(method, args)); // debounce :
...
const renderList = async page => {
  const list = await (0, _util.dummyFetcher)(_listBuilder.default, page); // DocumentFragment는 다른 노드를 담는 임시 컨테이너 역할을 하는 특수 목적의 노드이다. 
...
//# sourceMappingURL=/infinitescroll.e31bb0bc.js.map